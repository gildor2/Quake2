...
copy /b quake2.exe \games\quake2\*.* >NUL
copy /b ref_gl.dll \games\quake2\*.* >NUL
copy /b ref_oldgl.dll \games\quake2\*.* >NUL
rem copy /b ref_soft.dll \games\quake2\*.* >NUL
copy /b ..\4.XX_Changes.txt \games\quake2\*.* >NUL
cd \games\quake2\
