...
rem start \games\quake2\quake2.exe +set s_initsound 0 +set r_drawfps 1 +set developer 1 +set game dirty +echo
start \games\quake2\quake2.exe +set s_initsound 0 +set r_drawfps 1 +set game dirty +echo
