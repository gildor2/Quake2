...
#define glPolygonOffset	qgl.PolygonOffset
...
#define glSelectTextureCoordSetSGIS	qgl.SelectTextureCoordSetSGIS
#define glActiveTextureARB	qgl.ActiveTextureARB
#define glClientActiveTextureARB	qgl.ClientActiveTextureARB
...
#define QGL_ATI_TEXTURE_ENV_COMBINE3	(1 << 7)
#define QGL_S3_S3TC	(1 << 8)
#define QGL_ARB_TEXTURE_COMPRESSION	(1 << 9)
#define QGL_EXT_TEXTURE_COMPRESSION_S3TC	(1 << 10)
#define QGL_EXT_COMPILED_VERTEX_ARRAY	(1 << 11)
#define QGL_NV_TEXTURE_RECTANGLE	(1 << 12)
#define QGL_NV_FOG_DISTANCE	(1 << 13)
#define QGL_EXT_TEXTURE_LOD_BIAS	(1 << 14)
