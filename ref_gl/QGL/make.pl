...
const ("GL_COMBINE_ARB", "GL_COMBINE_RGB_ARB", "GL_COMBINE_ALPHA_ARB", "GL_RGB_SCALE_ARB",		# texenv_combine
...
const ("GL_ACTIVE_TEXTURE_ARB", "GL_CLIENT_ACTIVE_TEXTURE_ARB", "GL_MAX_TEXTURE_UNITS_ARB", "GL_TEXTURE0_ARB", "GL_TEXTURE1_ARB",
	"GL_TEXTURE2_ARB", "GL_TEXTURE3_ARB", "GL_MAX_TEXTURES_SGIS", "GL_TEXTURE0_SGIS", "GL_TEXTURE1_SGIS");			# multitexturing
