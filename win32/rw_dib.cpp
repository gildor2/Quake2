...
bool DIB_Init (byte **ppbuffer, int *ppitch)
{
	...
	*/
	sww_state.hDIBSection = CreateDIBSection (sww_state.hDC, pbmiDIB, DIB_RGB_COLORS, (void**)&sww_state.pDIBBase, NULL, 0);

	if ( sww_state.hDIBSection == NULL )
	{
		Com_WPrintf ("DIB_Init() - CreateDIBSection failed\n" );
		goto fail;
	}
